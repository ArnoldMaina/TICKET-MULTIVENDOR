...
INSERT INTO `merchant` (`id`, `name`, `email`, `password`, `is_active`) VALUES
(5, 'Bruno', 'brunomerchant@gmail.com', '$2y$10$qZ0OoyX8bhAVxDFM/fx8leZSZwlyq15c1C/KTnaqDLSx6eCDJ0VpC', '0'),
(8, 'Harry Den', 'jjden@gmail.com', '$2y$10$YKSDtra7v2wH6ORYfry8Ue9t49pk1AvQvdJGuq4lDvFLEcx.kP6Mq', '0');
...
INSERT INTO `products` (`product_id`, `product_cat`,`admin_id`,`product_brand`, `product_title`, `product_price`, `product_qty`,`VIP_price`, `VIP_qty`,`regular_price`, `regular_qty`,`children_qty`,`children_price`,`children_qty`,`advance_price`, `advance_qty`,  `product_desc`, `product_image`, `product_keywords`) VALUES
...
ALTER TABLE `products`
  ...
  ADD KEY `fk_product_admin` (`product_admin`)
  ;
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `fk_product_admin` FOREIGN KEY (`product_admin`) REFERENCES `admin` (`admin_id`)
  ;
