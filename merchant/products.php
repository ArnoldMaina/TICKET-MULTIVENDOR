  ...
  $("#myInput").on("keyup", function() {
    ...
    $("#product_list tr").filter(function() {
      ...
      <div class="row">
		...
		<div class="center">
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_product_modal" class="btn btn-warning btn-sm"><center>Add Event</center></a>
      	</div>
      </div>
	   </div>
        	...
        	<div class="row">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="<?php echo $_SESSION["admin_name"]; ?>" class="form-control"  readonly="readonly"/>
		        	</div>
        		</div>
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<textarea class="form-control" name="product_desc" placeholder="Enter payment info"></textarea>
		        	</div>
        		</div>
            <div class="col-12">
              <div class="form-group">
            ...
            <div class="col-12">
              <div class="form-group">
        		...
        		<div class="col-12">
				    ...
				    <h12><i> for one day event only fill from date for range events fill from and end dates</i></h12>
                    <div class="col-12">
                        ...
                        <h14><i> fill Only for weekly recurring events</i></h14>
                        <div class="col-12" > EVERY :
